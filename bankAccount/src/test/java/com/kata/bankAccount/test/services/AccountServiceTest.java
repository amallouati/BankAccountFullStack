...
public class AccountServiceTest {
	...
	public void setup() {
		...
		operations.add(new Operation(LocalDateTime.now(), OperationType.DEPOSIT, 10000L, account));
	...
	public void printStatement_return_current_account_balance() throws OperationFailException {
		...
		Operation operation = new Operation(LocalDateTime.now(), OperationType.DEPOSIT, 10000L, account);
